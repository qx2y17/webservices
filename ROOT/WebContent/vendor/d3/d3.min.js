...
function(t) {
    ...
    function i(t, n, e) {
        ...
        o = r / i;
        return o >= Ts ? i *= 10 : o >= ks ? i *= 5 : o >= Ns && (i *= 2),
        n < t ? -i: i
    }
    function o(t) {
        return t.length
    ...
    function l(t, n) {
        function e(e) {
            ...
            T = T.merge(N),
            S = S.merge(N.append("line").attr("stroke", "#000").attr(v + "2", d * l)),
            E = E.merge(N.append("text").attr("fill", "#000").attr(v, d * y).attr("dy", t === qs ? "0em": t === Ds ? "0.71em": "0.32em")),
            e !== w && (M = M.transition(e), T = T.transition(e), S = S.transition(e), E = E.transition(e), k = k.transition(e).attr("opacity", Fs).attr("transform",
            function(t) {
                return isFinite(t = b(t)) ? _(t) : this.getAttribute("transform")
            }), N.attr("opacity", Fs).attr("transform",
            function(t) {
                var n = this.parentNode.__axis;
                return _(n && isFinite(n = n(t)) ? n: b(t))
            })),
            k.remove(),
            M.attr("d", t === Os || t == Us ? "M" + d * h + "," + m + "H0.5V" + x + "H" + d * h: "M" + m + "," + d * h + "V0.5H" + x + "V" + d * h),
            ...
            S.attr(v + "2", d * l),
            E.attr(v, d * y).text(a),
            w.filter(f).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === Us ? "start": t === Os ? "end": "middle"),
            w.each(function() {
                this.__axis = b
            })
        }
    ...
    function vn() {
        ln(),
        ++Ml;
        for (var t, n = Vf; n;)(t = El - n._time) >= 0 && n._call.call(null, t),
        n = n._next; --Ml
    }
    function _n() {
        El = (Sl = Cl.now()) + Al,
    ...
    function gn() {
        for (var t, n, e = Vf,
        r = 1 / 0; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n: Vf = n);
        Wf = t,
        mn(r)
    }
    function mn(t) {
    ...
    function oe(t, n) {
        for (var e; ! (e = t.__transition) || !(e = e[n]);) if (! (t = t.parentNode)) return _h.time = ln(),
        _h;
        return e
    }
    function ue() {
    ...
    function he(n) {
        ...
        function u() {
            function e() {
                var t = Ks(w); ! L || x || b || (Math.abs(t[0] - U[0]) > Math.abs(t[1] - U[1]) ? b = !0 : x = !0),
                U = t,
                m = !0,
                xh(),
                o()
            ...
            function o() {
                ...
                case wh:
                case bh:
                    k && (y = Math.max(C - a, Math.min(P - p, y)), s = a + y, d = p + y),
                    N && (g = Math.max(z - l, Math.min(R - v, g)), h = l + g, _ = v + g);
                    break;
                case Mh:
                    k < 0 ? (y = Math.max(C - a, Math.min(P - a, y)), s = a + y, d = p) : k > 0 && (y = Math.max(C - p, Math.min(P - p, y)), s = a, d = p + y),
                    N < 0 ? (g = Math.max(z - l, Math.min(R - l, g)), h = l + g, _ = v) : N > 0 && (g = Math.max(z - v, Math.min(R - v, g)), h = l, _ = v + g);
                    break;
                case Th:
                    k && (s = Math.max(C, Math.min(P, a - y * k)), d = Math.max(C, Math.min(P, p + y * k))),
                    N && (h = Math.max(z, Math.min(R, l - g * N)), _ = Math.max(z, Math.min(R, v + g * N)))
                }
                d < s && (k *= -1, t = a, a = p, p = t, t = s, s = d, d = t, M in Ah && F.attr("cursor", Eh[M = Ah[M]])),
                _ < h && (N *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, M in Ch && F.attr("cursor", Eh[M = Ch[M]])),
            ...
            if (f.apply(this, arguments)) {
                ...
                "overlay" === M ? S.selection = A = [[a = n === Nh ? C: q[0], l = n === kh ? z: q[1]], [p = n === Nh ? P: a, v = n === kh ? R: l]] : (a = A[0][0], l = A[0][1], p = A[1][0], v = A[1][1]),
                s = a,
                h = l,
                d = p,
                _ = v;
                ...
                if (t.event.touches) O.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", u, !0);
                    ...
                    var I = cf(t.event.view).on("keydown.brush",
                    function() {
    ...
    function $e(n) {
        return _p = mp(n),
        t.format = _p.format,
        t.formatPrefix = _p.formatPrefix,
        _p
    }
    function Ve() {
        this.reset()
    ...
    function dr(t, n) {
        ...
        if (Up) {
            ...
            c = i[0] * ad * a,
            s = sd(u) > 180;
            s ^ (a * Rp < c && c < a * t) ? (o = i[1] * ad) > Pp && (Pp = o) : (c = (c + 360) % 360 - 180, s ^ (a * Rp < c && c < a * t) ? (o = -i[1] * ad) < Cp && (Cp = o) : (n < Cp && (Cp = n), n > Pp && (Pp = n))),
            s ? t < Rp ? xr(Ap, t) > xr(Ap, zp) && (zp = t) : xr(t, zp) > xr(Ap, zp) && (Ap = t) : zp >= Ap ? (t < Ap && (Ap = t), t > zp && (zp = t)) : t > Rp ? xr(Ap, t) > xr(Ap, zp) && (zp = t) : xr(t, zp) > xr(Ap, zp) && (Ap = t)
    ...
    function Or(t, n, e, r, i, o) {
        if (e) {
            ...
            for (var s, f = i; r > 0 ? f > o: f < o; f -= c) s = ur([u, -a * hd(f), -a * yd(f)]),
            t.point(s[0], s[1])
        }
    }
        ...
        return function(u) {
            ...
            T = {
                ...
                polygonEnd: function() {
                    var t = s(),
                    n = b && t,
                    e = (l = Cs(l)).length; (n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && Vd(l, a, t, o, u), u.polygonEnd()),
                    w = u,
                    l = h = p = null
                }
            };
    ...
    function ti() {
        ...
        t.extentMajor([[ - 180, -90 + ed], [180, 90 - ed]]).extentMinor([[ - 180, -80 - ed], [180, 80 + ed]])
    }
    function ni() {
        sv.point = ei
    }
    ...
    function Si(t, n) {
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                ...
                A = S - r,
                C = E - i,
                z = g * A - y * C; (z * z / m > n || sd((y * A + g * C) / m - .5) > .3 || u * h + a * p + c * d < Uv) && (e(r, i, o, u, a, c, S, E, k, x /= M, b /= M, w, v, _), _.point(S, E), e(S, E, k, x, b, w, s, f, l, h, p, d, v, _))
            }
        }
        return function(n) {
            function r(e, r) {
            ...
            function o(r, i) {
                var o = ar([r, i]),
                u = t(r, i);
                e(y, g, _, m, x, b, y = u[0], g = u[1], _ = r, m = o[0], x = o[1], b = o[2], qv, n),
                n.point(y, g)
            }
            function u() {
                w.point = r,
            ...
            function s() {
                e(y, g, _, m, x, b, l, h, f, p, d, v, qv, n),
                w.lineEnd = u,
                u()
            }
    ...
    function Ai(t) {
        ...
        n.clipExtent = function(t) {
            return arguments.length ? (S = null == t ? (N = l = h = p = null, uv) : Br(N = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == N ? null: [[N, l], [h, p]]
        },
        n.scale = function(t) {
    ...
    function eo(t, n) {
        ...
        s = [a];
        for (null == n && (n = ro); e = s.pop();) if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)) for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push(r = e.children[o] = new uo(i[o])),
        r.parent = e,
        r.depth = e.depth + 1;
    ...
    function Oo(t) {
        for (var n, e, r, i, o, u = new Do(t, 0), a = [u]; n = a.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new Do(r[i], i)),
        e.parent = n;
        return (u.parent = new Do(null, 0)).children = [u],
        u
    }
    function Fo(t, n, e, r, i, o) {
        for (var u, a, c, s, f, l, h, p, d, v, _, y = [], g = n.children, m = 0, x = 0, b = g.length, w = n.value; m < b;) {
            ...
            u.dice ? Vv(u, e, r, i, w ? r += s * f / w: o) : Jv(u, e, r, w ? e += c * f / w: i, o),
            w -= f,
            m = x
        }
        return y
    ...
    function au(t, n) {
        function e() {
            return i = Math.min(a.length, c.length) > 2 ? ou: iu,
            o = u = null,
            r
        }
        function r(n) {
    ...
    function Ma(n) {
        return Cy = Au(n),
        t.timeFormat = Cy.format,
        t.timeParse = Cy.parse,
        t.utcFormat = Cy.utcFormat,
        t.utcParse = Cy.utcParse,
        Cy
    }
    function Ta(t) {
        return new Date(t)
    ...
    function Na(t, n, e, r, o, u, a, c, s) {
        ...
        b = s("%B"),
        w = s("%Y"),
        M = [[a, 1, Oy], [a, 5, 5 * Oy], [a, 15, 15 * Oy], [a, 30, 30 * Oy], [u, 1, Fy], [u, 5, 5 * Fy], [u, 15, 15 * Fy], [u, 30, 30 * Fy], [o, 1, Iy], [o, 3, 3 * Iy], [o, 6, 6 * Iy], [o, 12, 12 * Iy], [r, 1, Yy], [r, 2, 2 * Yy], [e, 1, By], [n, 1, jy], [n, 3, 3 * jy], [t, 1, Hy]];
    ...
    function Ac(t, n, e, r) {
        ...
        e && zc(i, t, n, e),
        r && zc(i, n, t, r),
        im[t.index].halfedges.push(o),
        im[n.index].halfedges.push(o),
        i
    }
    function Cc(t, n, e) {
        var r = [n, e];
    ...
    function Fc() {
        for (var t, n, e, r, i = 0,
        o = im.length; i < o; ++i) if ((t = im[i]) && (r = (n = t.halfedges).length)) {
            var u = new Array(r),
            a = new Array(r);
            for (e = 0; e < r; ++e) u[e] = e,
            a[e] = Uc(t, um[n[e]]);
    ...
    function Ic(t, n, e, r) {
        ...
        y = !0;
        for (i = 0; i < _; ++i) if (o = im[i]) {
            for (u = o.site, a = (c = o.halfedges).length; a--;) um[c[a]] || c.splice(a, 1);
            for (a = 0, s = c.length; a < s;) d = (p = Oc(o, um[c[a]]))[0],
            v = p[1],
            l = (f = Dc(o, um[c[++a % s]]))[0],
            h = f[1],
            (Math.abs(d - l) > sm || Math.abs(v - h) > sm) && (c.splice(a, 0, um.push(Cc(u, p, Math.abs(d - t) < sm && r - v > sm ? [t, Math.abs(l - t) < sm ? h: r] : Math.abs(v - r) < sm && e - d > sm ? [Math.abs(h - r) < sm ? l: e, r] : Math.abs(d - e) < sm && v - n > sm ? [e, Math.abs(l - e) < sm ? h: n] : Math.abs(v - n) < sm && d - t > sm ? [Math.abs(h - n) < sm ? l: t, n] : null)) - 1), ++s);
            s && (y = !1)
        }
        if (y) {
            var g, m, x, b = 1 / 0;
        ...
        if (n && e) {
            ...
            if (r !== o) {
                ...
                if (! (h >= -fm)) {
                    ...
                    t.circle = y;
                    for (var g = null,
                    m = om._; m;) if (y.y < m.y || y.y === m.y && y.x <= m.x) {
                        if (!m.L) {
                            g = m.P;
                            break
                        }
    ...
    function Vc(t) {
        ...
        a = [t];
        $c(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < sm && Math.abs(r - c.circle.cy) < sm;) o = c.P,
        a.unshift(c),
        $c(c),
        c = o;
        a.unshift(c),
        jc(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < sm && Math.abs(r - s.circle.cy) < sm;) u = s.N,
        a.push(s),
        $c(s),
        s = u;
        a.push(s),
    ...
    function Wc(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = rm._; a;) if ((r = Zc(a, u) - o) > sm) a = a.L;
        else {
            if (! ((i = o - Gc(a, u)) > sm)) {
    ...
    function Kc(t, n) {
        ...
        for (um = [], im = new Array(t.length), rm = new Tc, om = new Tc;;) if (i = em, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Wc(o), e = o[0], r = o[1]),
        o = t.pop();
        else {
            if (!i) break;
            Vc(i.arc)
    ...
    vs = function(t, n) {
        ...
        a = 0,
        c = 0;
        if (null == n) for (; ++u < i;) isNaN(e = ds(t[u])) || (c += (r = e - a) * (e - (a += r / ++o)));
        else for (; ++u < i;) isNaN(e = ds(n(t[u], u, t))) || (c += (r = e - a) * (e - (a += r / ++o)));
        if (o > 1) return c / (o - 1)
    },
    _s = function(t, n) {
        var e = vs(t, n);
    ...
    Ss = function(t, n, e) {
        ...
        if (u > 0) for (t = Math.ceil(t / u), n = Math.floor(n / u), o = new Array(i = Math.ceil(n - t + 1)); ++c < i;) o[c] = (t + c) * u;
        else for (t = Math.floor(t * u), n = Math.ceil(n * u), o = new Array(i = Math.ceil(t - n + 1)); ++c < i;) o[c] = (t - c) / u;
        return a && o.reverse(),
        o
    },
    Es = function(t) {
    ...
    Ps = function(t) {
        ...
        for (var n = -1,
        e = zs(t, o), r = new Array(e); ++n < e;) for (var i, u = -1,
    ...
    Gs = {};
    t.event = null,
    "undefined" != typeof document && ("onmouseenter" in document.documentElement || (Gs = {
    ...
    sf = function(t, n, e) {
        ...
        for (var r, i = 0,
        o = n ? n.length: 0; i < o; ++i) if ((r = n[i]).identifier === e) return Qs(t, r);
        return null
    },
    ff = function() {
    ...
    al = function(t, n) {
        ...
        a = [],
        c = [];
        for (t += "", n += ""; (e = ol.exec(t)) && (r = ul.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i: a[++u] = i),
    ...
    pn.prototype = dn.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            this._next || Wf === this || (Wf ? Wf._next = this: Vf = this, Wf = this),
            this._call = t,
            this._time = e,
            mn()
        },
    ...
    Gn.prototype = Jn.prototype = {
        ...
        select: function(t) {
            ...
            i = r.length,
            o = new Array(i), u = 0; u < i; ++u) for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Bl(l[h], n, e, h, l, wn(a, e)));
    ...
    dt.prototype.transition = function(t) {
        ...
        for (var r = this._groups,
        i = r.length,
        o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && Bl(u, t, n, s, a, e || oe(u, n));
    ...
    de.prototype = ve.prototype = {
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            e && (l < 0 && (l = l % Bh + Bh), l > jh ? this._ += "A" + e + "," + e + ",0,1," + f + "," + (t - u) + "," + (n - a) + "A" + e + "," + e + ",0,1," + f + "," + (this._x1 = c) + "," + (this._y1 = s) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= Yh) + "," + f + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
        ...
        function n(t, n) {
            function e() {
                ...
                if (34 === t.charCodeAt(e)) {
                    ...
                    return f = r + 2,
                    13 === (n = t.charCodeAt(r + 1)) ? (i = !0, 10 === t.charCodeAt(r + 2) && ++f) : 10 === n && (i = !0),
            ...
            for (var r, i, u = {},
            a = {},
            c = [], s = t.length, f = 0, l = 0; (r = e()) !== a;) {
                for (var h = []; r !== u && r !== a;) h.push(r),
                r = e();
    ...
    op.find = function(t, n, e) {
        ...
        d = [],
        v = this._root;
        for (v && d.push(new ip(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();) if (! (! (v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l)) if (v.length) {
            var _ = (i + u) / 2,
            y = (o + a) / 2;
            d.push(new ip(v[3], _, y, u, a), new ip(v[2], i, y, _, a), new ip(v[1], _, o, u, y), new ip(v[0], i, o, _, y)),
    ...
    op.visit = function(t) {
        var n, e, r, i, o, u, a = [],
        c = this._root;
        for (c && a.push(new ip(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, u = n.y1) && c.length) {
            var s = (r + o) / 2,
            f = (i + u) / 2; (e = c[3]) && a.push(new ip(e, s, f, o, u)),
            (e = c[2]) && a.push(new ip(e, r, f, s, u)),
            (e = c[1]) && a.push(new ip(e, s, i, o, f)),
            (e = c[0]) && a.push(new ip(e, r, i, s, f))
        }
        return this
    },
    op.visitAfter = function(t) {
        ...
        for (this._root && e.push(new ip(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop();) {
            ...
            if (i.length) {
                ...
                s = n.y1,
                f = (u + c) / 2,
                l = (a + s) / 2; (o = i[0]) && e.push(new ip(o, u, a, f, l)),
                (o = i[1]) && e.push(new ip(o, f, a, c, l)),
                (o = i[2]) && e.push(new ip(o, u, l, f, s)),
                (o = i[3]) && e.push(new ip(o, f, l, c, s))
            }
            r.push(n)
        }
        ...
        function n(t) {
            function n(t) {
                ...
                t = "";
                    ...
                    var b = (t = +t) < 0;
                    if (t = g(Math.abs(t), d), b && 0 == +t && (b = !1), f = (b ? "(" === s ? s: "-": "-" === s || "(" === s ? "": s) + f, x = x + ("s" === v ? gp[8 + up / 3] : "") + (b && "(" === s ? ")": ""), m) for (n = -1, r = t.length; ++n < r;) if (48 > (u = t.charCodeAt(n)) || u > 57) {
    ...
    Ve.prototype = {
        ...
        add: function(t) {
            We(nd, t, this.t),
            We(this, nd.s, this.s),
            this.s ? this.t += nd.t: this.s = nd.t
        },
        valueOf: function() {
            return this.s
        }
    ...
    Ed = {
        ...
        polygonEnd: function() {
            ...
            Ed.lineStart = vr,
            Ed.lineEnd = _r,
            Td < 0 ? (Ap = -(zp = 180), Cp = -(Pp = 90)) : Sd > ed ? Pp = 90 : Sd < -ed && (Cp = -90),
            Op[0] = Ap,
            Op[1] = zp
        }
    },
    ...
    var Pd, Rd, Ld, qd, Ud, Dd, Od, Fd, Id, Yd, Bd, jd = function(t) {
        function n(n) {
            return n = t(n[0] * cd, n[1] * cd),
            n[0] *= ad,
            n[1] *= ad,
            n
        }
        return t = Lr(t[0] * cd, t[1] * cd, t.length > 2 ? t[2] * cd: 0),
        n.invert = function(n) {
            return n = t.invert(n[0] * cd, n[1] * cd),
            n[0] *= ad,
            n[1] *= ad,
            n
        },
    ...
    Jd = function(t, n) {
        ...
        Gd.reset();
        for (var a = 0,
        c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + od, d = yd(p), v = hd(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
            var y = s[_],
            g = y[0],
            m = y[1] / 2 + od,
            x = yd(m),
            ...
            if (Gd.add(ld(N * M * yd(T), v * b + N * hd(T))), o += k ? w + M * ud: w, k ^ h >= e ^ g >= e) {
                ...
                var E = sr(i, S);
                hr(E);
                var A = (k ^ w >= 0 ? -1 : 1) * Ge(E[2]); (r > A || r === A && (S[0] || S[1])) && (u += k ^ w >= 0 ? 1 : -1)
            }
        }
    ...
    iv = {
        ...
        FeatureCollection: function(t, n) {
            for (var e = t.features,
            r = -1,
            i = e.length; ++r < i;) if ($r(e[r].geometry, n)) return ! 0;
            return ! 1
        }
    },
    ov = {
        ...
        MultiPoint: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (Vr(e[r], n)) return ! 0;
            return ! 1
        },
        LineString: function(t, n) {
        ...
        MultiLineString: function(t, n) {
            for (var e = t.coordinates,
            r = -1,
            i = e.length; ++r < i;) if (Wr(e[r], n)) return ! 0;
            return ! 1
        },
        Polygon: function(t, n) {
        ...
        GeometryCollection: function(t, n) {
            for (var e = t.geometries,
            r = -1,
            i = e.length; ++r < i;) if ($r(e[r], n)) return ! 0;
            return ! 1
        }
    },
    uv = function(t) {
    ...
    sv = {
        ...
        polygonEnd: function() {
            sv.lineStart = sv.lineEnd = sv.point = Qe,
            av.add(sd(cv)),
            cv.reset()
        },
        result: function() {
    ...
    Tv = {
        ...
        result: function() {
            ...
            return vv = _v = yv = gv = mv = xv = bv = wv = Mv = 0,
            t
        }
    };
    di.prototype = {
        ...
        point: function(t, n) {
            ...
            default:
                ...
                this._context.arc(t, n, this._radius, 0, ud)
            }
        },
        result: Qe
    };
        ...
        return function(i, o) {
            ...
            b = {
                ...
                polygonEnd: function() {
                    ...
                    d = Cs(d);
                    var t = Jd(p, y);
                    d.length ? (x || (o.polygonStart(), x = !0), Vd(d, xi, t, e, o)) : t && (x || (o.polygonStart(), x = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()),
                    x && (o.polygonEnd(), x = !1),
                    d = p = null
                },
                sphere: function() {
    ...
    function(t) {
        ...
        return {
            ...
            point: function(o, u) {
                var a = o > 0 ? rd: -rd,
                c = sd(o - e);
                sd(c - rd) < ed ? (t.point(e, r = (r + u) / 2 > 0 ? id: -id), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), n = 0) : i !== a && c >= rd && (sd(e - i) < ed && (e -= i * ed), sd(o - a) < ed && (o -= a * ed), r = bi(e, r, o, u), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), n = 0),
                t.point(e = o, r = u),
                i = a
            },
            lineEnd: function() {
        ...
        function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    if (!n && (s = c = v) && t.lineStart(), v !== c && (!(p = r(n, d)) || $d(n, p) || $d(d, p)) && (d[0] += ed, d[1] += ed, v = e(d[0], d[1])), v !== c) f = 0,
                    v ? (t.lineStart(), p = r(d, n), t.point(p[0], p[1])) : (p = r(n, d), t.point(p[0], p[1]), t.lineEnd()),
                    n = p;
                    else if (a && n && u ^ v) {
                        var y;
    ...
    Hv = function(t) {
        for (var n, e, r = 0,
        i = (t = ao(jv.call(t))).length, o = []; r < i;) n = t[r],
        e && fo(e, n) ? ++r: (e = ho(o = co(o, n)), r = 0);
        return e
    },
    Xv = function(t) {
        return function() {
    ...
    t_ = function t(n) {
        function e(t, e, r, i, o) {
            ...
            p = t.value; ++l < h;) {
                ...
                a.dice ? Vv(a, e, r, i, r += (o - r) * a.value / p) : Jv(a, e, r, e += (i - e) * a.value / p, o),
                p -= a.value
            } else t._squarify = u = Fo(n, t, e, r, i, o),
            u.ratio = n
        }
        return e.ratio = function(n) {
            return t((n = +n) > 1 ? n: 1)
    ...
    Bo.prototype = Wo.prototype = {
        ...
        abort: function() {
            return null == this._error && $o(this, new Error("abort")),
            this
        },
        await: function(t) {
            if ("function" != typeof t) throw new Error("invalid callback");
    ...
    S_ = function(n, e, r) {
        ...
        case "s":
            ...
            return null != r.precision || isNaN(o = bp(c, s)) || (r.precision = o),
            t.formatPrefix(r, s);
        case "":
        case "e":
        case "g":
    ...
    z_.every = function(t) {
        return t = Math.floor(t),
        isFinite(t) && t > 0 ? t > 1 ? Mu(function(n) {
    ...
    Dy = +new Date("2000-01-01T00:00:00.000Z") ?
    function(t) {
        var n = new Date(t);
    ...
    Bg = {
        draw: function(t, n) {
            ...
            t.lineTo(o, u),
            t.lineTo(a, c),
            t.lineTo(Og * r - Fg * i, Fg * r + Og * i),
            t.lineTo(Og * o - Fg * u, Fg * o + Og * u),
            t.lineTo(Og * a - Fg * c, Fg * a + Og * c),
            t.lineTo(Og * r + Fg * i, Og * i - Fg * r),
            t.lineTo(Og * o + Fg * u, Og * u - Fg * o),
            t.lineTo(Og * a + Fg * c, Og * c - Fg * a),
            t.closePath()
        }
    },
    ...
    dc.prototype = {
        ...
        point: function(t, n) {
            ...
            if (t = +t, n = +n, t !== this._x1 || n !== this._y1) {
                ...
                case 2:
                    this._point = 3,
                    pc(this, hc(this, e = lc(this, t, n)), e);
                    break;
                default:
    ...
    yc.prototype = {
        ...
        lineEnd: function() {
            ...
            else for (var r = gc(t), i = gc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]); (this._line || 0 !== this._line && 1 === e) && this._context.closePath(),
            this._line = 1 - this._line,
            this._x = this._y = null
        },
        point: function(t, n) {
    ...
    Tc.prototype = {
        ...
        insert: function(t, n) {
            ...
            for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Nc(this, e), e = (t = e).U), e.C = !1, r.C = !0, Sc(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (Sc(this, e), e = (t = e).U), e.C = !1, r.C = !0, Nc(this, r)),
            e = t.U;
            this._.C = !1
        },
        remove: function(t) {
            ...
            o = t.L,
            u = t.R;
            if (e = o ? u ? Ec(u) : o: u, i ? i.L === t ? i.L = e: i.R = e: this._ = e, o && u ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== u ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = u, u.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1;
            else {
                do {
                    if (t === this._) break;
                    if (t === i.L) {
                        if ((n = i.R).C && (n.C = !1, i.C = !0, Nc(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
                            n.R && n.R.C || (n.L.C = !1, n.C = !0, Sc(this, n), n = i.R),
                            n.C = i.C,
                            i.C = n.R.C = !1,
                            Nc(this, i),
                            t = this._;
                        ...
                        n.L && n.L.C || (n.R.C = !1, n.C = !0, Nc(this, n), n = i.L),
                        n.C = i.C,
                        i.C = n.L.C = !1,
                        Sc(this, i),
                        t = this._;
    ...
    Kc.prototype = {
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                ...
                u && f && r < u.index && r < f.index && Jc(a, u, f) < 0 && t.push([a.data, u.data, f.data])
            }),
            t
        },
        links: function() {
    ...
    t.thresholdFreedmanDiaconis = function(t, n, e) {
        return t = xs.call(t, ds).sort(ss),
        Math.ceil((e - n) / (2 * (As(t, .75) - As(t, .25)) * Math.pow(t.length, -1 / 3)))
    },
    ...
    t.ribbon = function() {
        function t() {
            ...
            _ = i.apply(this, a) - Uh,
            y = o.apply(this, a) - Uh;
            if (u || (u = t = ve()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === y || (u.quadraticCurveTo(0, 0, v * Rh(_), v * Lh(_)), u.arc(0, 0, v, _, y)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t) return u = null,
            t + "" || null
        }
        var n = _e,
        e = ye,
    ...
    t.drag = function() {
        ...
        function c(e, r, i, o, u) {
            var a, c, s, f = i(r, e),
            l = g.copy();
            if (N(new yt(n, "beforestart", a, e, m, f[0], f[1], 0, 0, l),
            function() {
    ...
    t.forceCollide = function(t) {
        ...
        var i, o, u = 1,
        a = 1;
        return "function" != typeof t && (t = ep(null == t ? 1 : +t)),
    ...
    t.forceLink = function(t) {
        function n(n) {
            ...
            f = (c = i.target).x + c.vx - a.x - a.vx || rp(),
            l = c.y + c.vy - a.y - a.vy || rp(),
    ...
    t.forceManyBody = function() {
        ...
        function r(t, n, e, r) {
            ...
            h = r - n,
            p = i * i + c * c;
            if (h * h / l < p) return p < f && (0 === i && (i = rp(), p += i * i), 0 === c && (c = rp(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p),
            !0;
            if (! (t.length || p >= f)) { (t.data !== o || t.next) && (0 === i && (i = rp(), p += i * i), 0 === c && (c = rp(), p += c * c), p < s && (p = Math.sqrt(s * p)));
                do {
    ...
    t.forceX = function(t) {
        ...
        var r, i, o, u = ep(.1);
        return "function" != typeof t && (t = ep(null == t ? 0 : +t)),
        n.initialize = function(t) {
            r = t,
            e()
        },
    ...
    t.geoBounds = function(t) {
        ...
        if (Pp = zp = -(Ap = Cp = 1 / 0), Dp = [], Md(t, Ed), e = Dp.length) {
            ...
            (a = xr(r[1], i[0])) > u && (u = a, Ap = i[0], zp = r[1])
        }
        return Dp = Op = null,
        Ap === 1 / 0 || Cp === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Ap, Cp], [zp, Pp]]
    },
    t.geoCentroid = function(t) {
        Fp = Ip = Yp = Bp = jp = Hp = Xp = $p = Vp = Wp = Zp = 0,
        Md(t, Ad);
        var n = Vp,
        e = Wp,
        r = Zp,
    ...
    t.geoPath = function(t, n) {
        function e(t) {
            return t && ("function" == typeof o && i.pointRadius( + o.apply(this, arguments)), Md(t, r(i))),
            i.result()
        }
        var r, i, o = 4.5;
    ...
    t.geoAlbersUsa = function() {
        ...
        t.translate = function(t) {
            ...
            o = s.translate([r - .307 * e, a + .201 * e]).clipExtent([[r - .425 * e + ed, a + .12 * e + ed], [r - .214 * e - ed, a + .234 * e - ed]]).stream(l),
            u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([[r - .214 * e + ed, a + .166 * e + ed], [r - .115 * e - ed, a + .234 * e - ed]]).stream(l),
            n()
        },
    ...
    t.geoIdentity = function() {
        ...
        return u = {
            ...
            clipExtent: function(i) {
                return arguments.length ? (d = null == i ? (p = n = e = r = null, uv) : Br(p = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]), t()) : null == p ? null: [[p, n], [e, r]]
            },
            scale: function(n) {
    ...
    t.pack = function() {
        function t(t) {
            return t.x = e / 2,
            t.y = r / 2,
            n ? t.eachBefore(No(n)).eachAfter(So(i, .5)).eachBefore(Eo(1)) : t.eachBefore(No(ko)).eachAfter(So(To, 1)).eachAfter(So(i, t.r / Math.min(e, r))).eachBefore(Eo(Math.min(e, r) / (2 * t.r))),
            t
        }
        var n = null,
        e = 1,
    ...
    t.stratify = function() {
        function t(t) {
            ...
            for (i = 0; i < f; ++i) r = t[i],
            a = l[i] = new uo(r),
            null != (c = n(r, i, t)) && (c += "") && (h[s = Wv + (a.id = c)] = s in h ? Gv: a);
    ...
    t.tree = function() {
        ...
        function r(t, n, e) {
            if (n) {
                ...
                u = t,
                a = n,
                c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m; a = Ro(a), i = Po(i), a && i;) c = Po(c),
                (u = Ro(u)).a = t,
                (r = a.z + l - i.z - s + o(a._, i._)) > 0 && (Lo(Uo(a, t, e), t, r), s += r, f += r),
                l += a.m,
                s += i.m,
                h += c.m,
                f += u.m;
    ...
    t.treemapDice = Vv,
    t.treemapSlice = Jv,
    t.treemapSliceDice = function(t, n, e, r, i) { (1 & t.depth ? Jv: Vv)(t, n, e, r, i)
    },
    t.treemapSquarify = Kv,
    t.treemapResquarify = t_,
    t.interpolate = cl,
    ...
    t.randomUniform = o_,
    t.randomNormal = u_,
    t.randomLogNormal = a_,
    t.randomBates = s_,
    t.randomIrwinHall = c_,
    t.randomExponential = f_,
    t.request = l_,
    t.html = p_,
    t.json = d_,
    t.text = v_,
    ...
    t.schemeCategory10 = $y,
    t.schemeCategory20b = Vy,
    t.schemeCategory20c = Wy,
    t.schemeCategory20 = Zy,
    t.interpolateCubehelixDefault = Gy,
    t.interpolateRainbow = function(t) { (t < 0 || t > 1) && (t -= Math.floor(t));
        var n = Math.abs(t - .5);
        return Ky.h = 360 * t - 100,
        Ky.s = 1.5 - 1.5 * n,
        Ky.l = .8 - .9 * n,
        Ky + ""
    },
    t.interpolateWarm = Jy,
    t.interpolateCool = Qy,
    t.interpolateViridis = tg,
    t.interpolateMagma = ng,
    t.interpolateInferno = eg,
    t.interpolatePlasma = rg,
    ...
    t.touches = function(t, n) {
        null == n && (n = Js().touches);
        for (var e = 0,
        r = n ? n.length: 0, i = new Array(r); e < r; ++e) i[e] = Qs(t, n[e]);
        return i
    },
    t.window = uf,
    t.customEvent = N,
    t.arc = function() {
        function t() {
            ...
            d = og(p - h),
            v = p > h;
            if (c || (c = t = ve()), l < f && (s = l, l = f, f = s), l > hg) if (d > vg - hg) c.moveTo(l * ag(h), l * fg(h)),
            c.arc(0, 0, l, h, p, !v),
            f > hg && (c.moveTo(f * ag(p), f * fg(p)), c.arc(0, 0, f, p, h, v));
            else {
                var _, y, g = h,
                m = p,
                x = h,
                ...
                if (k > hg) {
                    var A = Ca(k / f * fg(T)),
                    C = Ca(k / l * fg(T)); (w -= 2 * A) > hg ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2),
                    (M -= 2 * C) > hg ? (C *= v ? 1 : -1, g += C, m -= C) : (M = 0, g = m = (h + p) / 2)
                }
                var z = l * ag(g),
                P = l * fg(g),
                R = f * ag(b),
                ...
                M > hg ? E > hg ? (_ = Da(D, O, z, P, l, E, v), y = Da(q, U, R, L, l, E, v), c.moveTo(_.cx + _.x01, _.cy + _.y01), E < N ? c.arc(_.cx, _.cy, E, ug(_.y01, _.x01), ug(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, E, ug(_.y01, _.x01), ug(_.y11, _.x11), !v), c.arc(0, 0, l, ug(_.cy + _.y11, _.cx + _.x11), ug(y.cy + y.y11, y.cx + y.x11), !v), c.arc(y.cx, y.cy, E, ug(y.y11, y.x11), ug(y.y01, y.x01), !v))) : (c.moveTo(z, P), c.arc(0, 0, l, g, m, !v)) : c.moveTo(z, P),
                f > hg && w > hg ? S > hg ? (_ = Da(R, L, q, U, f, -S, v), y = Da(z, P, D, O, f, -S, v), c.lineTo(_.cx + _.x01, _.cy + _.y01), S < N ? c.arc(_.cx, _.cy, S, ug(_.y01, _.x01), ug(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, S, ug(_.y01, _.x01), ug(_.y11, _.x11), !v), c.arc(0, 0, f, ug(_.cy + _.y11, _.cx + _.x11), ug(y.cy + y.y11, y.cx + y.x11), v), c.arc(y.cx, y.cy, S, ug(y.y11, y.x11), ug(y.y01, y.x01), !v))) : c.arc(0, 0, f, b, x, v) : c.lineTo(R, L)
            } else c.moveTo(0, 0);
    ...
    t.curveBundle = Xg,
    t.curveCardinalClosed = Vg,
    t.curveCardinalOpen = Wg,
    t.curveCardinal = $g,
    t.curveCatmullRomClosed = Gg,
    t.curveCatmullRomOpen = Jg,
    t.curveCatmullRom = Zg,
    ...
    t.timeInterval = Mu,
    t.timeMillisecond = z_,
    t.timeMilliseconds = P_,
    t.utcMillisecond = z_,
    t.utcMilliseconds = P_,
    t.timeSecond = q_,
    t.timeSeconds = U_,
    t.utcSecond = q_,
    t.utcSeconds = U_,
    ...
    t.zoom = function() {
        ...
        function a(t, n) {
            for (var e, r = 0,
            i = C.length; r < i; ++r) if ((e = C[r]).that === t) return e;
            return new c(t, n)
        }
        function c(t, n) {
            this.that = t,
        ...
        function f() {
            if (!y && g.apply(this, arguments)) {
                ...
                e = cf(t.event.view).on("mousemove.zoom",
                function() {
                    if (pm(), !n.moved) {
        ...
        function l() {
            if (g.apply(this, arguments)) {
                ...
                pm(),
                E > 0 ? cf(this).transition().duration(E).call(u, s, a) : cf(this).call(n.transform, s)
            }
        }
        function p() {
            if (g.apply(this, arguments)) {
                ...
                c = u.length;
                for (rs(), e = 0; e < c; ++e) r = u[e],
                i = [i = sf(this, u, r.identifier), this.__zoom.invert(i), r.identifier],
                o.touch0 ? o.touch1 || (o.touch1 = i) : (o.touch0 = i, n = !0);
                if (_ && (_ = clearTimeout(_), !o.touch1)) return o.end(),
                void((i = cf(this).on("dblclick.zoom")) && i.apply(this, arguments));
        ...
        function d() {
            ...
            l = f.length;
            for (pm(), _ && (_ = clearTimeout(_)), n = 0; n < l; ++n) o = f[n],
        ...
        c.prototype = {
            start: function() {
                return 1 == ++this.active && (this.index = C.push(this) - 1, this.emit("start")),
                this
            },
            zoom: function(t, n) {
                ...
                return 0 == --this.active && (C.splice(this.index, 1), this.index = -1, this.emit("end")),
                this
            },
            emit: function(t) {
        ...
        n.extent = function(t) {
            return arguments.length ? (m = "function" == typeof t ? t: lm([[ + t[0][0], +t[0][1]], [ + t[1][0], +t[1][1]]]), n) : m
        },
